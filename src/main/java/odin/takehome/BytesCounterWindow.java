...
public class BytesCounterWindow {

//TODO: Add assumption that all data is from same year/month
    ...
    private static class ExtractWordsFn extends DoFn<String, KV<String, KV<LocalDateTime, Long>>> {
        ...
        public void processElement(@Element String element, OutputReceiver<KV<String, KV<LocalDateTime, Long>>> receiver) {
            ...
            int YEAR = LocalDateTime.now(ZoneId.of("UTC")).getYear();
            int MONTH = LocalDateTime.now(ZoneId.of("UTC")).getMonthValue();
        ...
        public void processElement(ProcessContext c) {
            ...
            for (int i = 1; i< metadata.size(); i++) {
                ...
                if (elementTime.toEpochSecond(ZoneOffset.UTC) - prevTimestamp.toEpochSecond(ZoneOffset.UTC) <= SECONDS_IN_HOURS) {
                    ...
                    result.add(KV.of(prevTimestamp, totalBytesHour));//TODO: Add that smallest time is taken as "first hour" can be different for each entry
